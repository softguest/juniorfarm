...
export function GalleryHero() {
  return (
    <section className="relative pt-32 pb-20 bg-gradient-to-br from-muted via-background to-primary/10 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Capturing moments from the field - farming activities, training workshops, conferences, and community events
          </motion.p>
        </motion.div>
      </div>
