...
export function ProjectsHero() {
  return (
    <section className="relative pt-32 pb-20 bg-gradient-to-br from-secondary/10 via-background to-primary/10 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Innovative solutions driving sustainable agriculture and community empowerment across Cameroon
          </motion.p>
        </motion.div>
      </div>
