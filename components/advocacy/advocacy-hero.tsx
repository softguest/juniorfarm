...
export function AdvocacyHero() {
  return (
    <section className="relative pt-32 pb-20 bg-gradient-to-br from-primary/10 via-background to-accent/10 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Advocacy & <span className="text-primary">Impact</span>
          </motion.h1>
          ...
          >
            Championing climate action, empowering youth leaders, and building stronger agricultural communities
          </motion.p>
        </motion.div>
      </div>
